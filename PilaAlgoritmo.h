...
public:
	...
	void agregarPila(PilaAlgoritmo * &pila,Algoritmo nodoTemp) {//Cuando da click a siguiente se va a hacer un nuevo objeto de tipo algoritmo y se va a agregar aqui
